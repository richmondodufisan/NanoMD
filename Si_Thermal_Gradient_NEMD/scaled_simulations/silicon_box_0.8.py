...
desired_box = np.array([160.0, 25, 25])
...
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.8.data', format='lammps-data')
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.8.xyz')
