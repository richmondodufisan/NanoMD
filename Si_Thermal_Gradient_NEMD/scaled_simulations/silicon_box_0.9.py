...
desired_box = np.array([180.0, 25, 25])
...
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.9.data', format='lammps-data')
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.9.xyz')
