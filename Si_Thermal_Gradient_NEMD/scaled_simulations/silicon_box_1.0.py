...
desired_box = np.array([200.0, 25, 25])
...
trimmed_supercell.write('scaled_simulations/Silicon_supercell_1.0.data', format='lammps-data')
trimmed_supercell.write('scaled_simulations/Silicon_supercell_1.0.xyz')
