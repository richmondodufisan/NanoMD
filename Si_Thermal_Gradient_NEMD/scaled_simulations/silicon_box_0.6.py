...
desired_box = np.array([120.0, 25, 25])
...
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.6.data', format='lammps-data')
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.6.xyz')
