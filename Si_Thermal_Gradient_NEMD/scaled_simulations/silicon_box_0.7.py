...
desired_box = np.array([140.0, 25, 25])
...
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.7.data', format='lammps-data')
trimmed_supercell.write('scaled_simulations/Silicon_supercell_0.7.xyz')
