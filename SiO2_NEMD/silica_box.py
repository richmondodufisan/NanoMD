...
unit_cell = read('SiO2.cif')  # Replace with your CIF file path
...
trimmed_supercell.write('Silica_supercell_200x25x25.data', format='lammps-data')
trimmed_supercell.write('Silica_supercell_200x25x25.xyz')
