...
if __name__ == "__main__":
    filename = './lammps_out/heat_flux_output_middle_left_1.3.txt'  # Replace with the path to your file
    ...
    plot_heat_flux(time, heat_flux, smoothed_flux, 'flux_v_time1.3.png')
