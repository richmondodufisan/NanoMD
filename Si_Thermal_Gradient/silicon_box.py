...
desired_box = np.array([2000, 500, 500])
...
trimmed_supercell.write('Silicon_supercell_2000x500x500.data', format='lammps-data')

# Optionally, you can also save as an XYZ file if needed
trimmed_supercell.write('Silicon_supercell_2000x500x500.xyz')
