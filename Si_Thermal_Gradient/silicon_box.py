...
desired_box = np.array([400, 100, 100])
...
trimmed_supercell.write('Silicon_supercell_400x100x100.data', format='lammps-data')

# Optionally, you can also save as an XYZ file if needed
trimmed_supercell.write('Silicon_supercell_400x100x100.xyz')
